...
export interface ApiAppointmentAppointment extends Schema.CollectionType {
  ...
  attributes: {
    ...
    therapist: Attribute.Relation<
      'api::appointment.appointment',
      'manyToOne',
      'api::therapist.therapist'
    >;
...
export interface ApiCategoryCategory extends Schema.CollectionType {
  ...
  attributes: {
    Name: Attribute.String & Attribute.Required;
    Icon: Attribute.Media<'images' | 'videos'> & Attribute.Required;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiDocCategoryDocCategory extends Schema.CollectionType {
  ...
  attributes: {
    Name: Attribute.String &
      Attribute.Required &
      Attribute.DefaultTo<'Physiotherapist'>;
    Image: Attribute.Media<'images'> & Attribute.Required;
    therapists: Attribute.Relation<
...
export interface ApiTherapistTherapist extends Schema.CollectionType {
  ...
  attributes: {
    ...
    About: Attribute.RichText &
      Attribute.Required &
      Attribute.DefaultTo<'My bio...'>;
    Phone: Attribute.String &
      Attribute.Required &
      Attribute.DefaultTo<'(201) 561-2688'>;
    Image: Attribute.Media<'images'> & Attribute.Required;
    Premium: Attribute.Boolean;
    doc_category: Attribute.Relation<
      'api::therapist.therapist',
      'manyToOne',
      'api::doc-category.doc-category'
    >;
    LocationLink: Attribute.String &
      Attribute.Required &
      Attribute.DefaultTo<'https://maps.app.goo.gl/nYu9Rz2o2xFnwzWc6?g_st=ic'>;
    Zocdoc: Attribute.String;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::therapist.therapist': ApiTherapistTherapist;
    }
  }
}
